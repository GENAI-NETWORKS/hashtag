  ...
  const CardInner = (
    <>
      ...
      <div className="relative overflow-hidden bg-[#f4f6f8] aspect-square rounded-t-xl">
        ...
        />
        {product.bestseller && (
          <span className="absolute top-2 left-2 bg-[#EC008C] text-white text-[11px] font-black px-2 py-0.5 rounded-full flex items-center gap-0.5">
            <Zap size={8} /> Best
          </span>
        )}
        {/* Wishlist heart */}
      ...
      <div className="bg-gradient-to-b from-[#91250b] to-[#7a1b06] px-4 pt-4 pb-8 rounded-b-[32px] relative overflow-hidden text-white shadow-md">
          ...
          <div className="flex items-center justify-between w-full">
            <Link href="/" className="flex flex-row items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-black text-[17px] leading-tight tracking-wide uppercase bg-gradient-to-r from-[#00AEEF] via-[#EC008C] to-[#FFF200] text-transparent bg-clip-text drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">
                  Your Ideas,
                </span>
                <span className="text-white/95 text-[12px] sm:text-[13px] font-bold tracking-widest flex items-center gap-1.5 uppercase mt-0.5 drop-shadow-[0_1px_1px_rgba(0,0,0,0.5)]">
            ...
            <div className="flex items-center gap-2.5">
              <Link href="/cart" className="bg-black/40 p-2.5 rounded-full border border-white/10 relative shadow-inner touch-target hover:scale-105 transition-transform">
                 ...
                 <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-[#333] text-white text-[11px] font-bold px-1.5 py-0.5 rounded-full border border-[#555] whitespace-nowrap">₹0</div>
              </Link>
        ...
        <div className="flex items-start justify-between relative z-10 px-2 sm:px-6">
           <Link href="/products" className="flex flex-col items-center gap-1.5 group">
              ...
              <span className="text-[14px] font-bold border-b-[3px] border-white pb-0.5">All</span>
           </Link>

           <Link href="/products?category=custom-gifts-printing" className="flex flex-col items-center gap-1.5 relative group">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#EC008C] text-white text-[12px] font-black px-2 py-0.5 rounded-full border border-white whitespace-nowrap z-10 shadow-sm animate-pulse">New</div>
              <div className="w-12 h-12 flex flex-col items-center justify-end group-hover:scale-110 transition-transform text-[28px]">
                🪔
              </div>
              <span className="text-[14px] font-bold text-[#FFD700]">Diwali Offers</span>
           </Link>
           ...
           <Link href="/products?category=custom-tshirt-printing" className="flex flex-col items-center gap-1.5 group">
              ...
              <span className="text-[14px] font-semibold opacity-90">T-Shirts</span>
           </Link>
           ...
           <Link href="/products?category=custom-gifts-printing" className="flex flex-col items-center gap-1.5 group">
              ...
              <span className="text-[14px] font-semibold opacity-90">Gifts</span>
           </Link>
        </div>
      </div>
        ...
        <section aria-labelledby="festive-heading" className="-mx-4 px-4 py-8 mb-8 relative overflow-hidden bg-gradient-to-b from-[#FFF5E1] to-[#FFE8B5]/40 border-y-2 border-[#FFD700]/50 shadow-inner">
          ...
          <div className="flex flex-col items-center justify-center mb-6 relative z-10">
             <div className="flex items-center gap-3">
               ...
               <h2 id="festive-heading" className="text-[28px] sm:text-[32px] font-serif font-black text-transparent bg-clip-text bg-gradient-to-r from-[#8B1C10] to-[#b32415] tracking-wide drop-shadow-sm">Festive Picks</h2>
               <span className="text-[24px] animate-pulse">🪔</span>
             </div>
          ...
          <div className="flex overflow-x-auto gap-4 pb-4 pt-4 snap-x hide-scrollbar relative z-10">
            {bestsellers.map((p, i) => (
              <div key={p.id} className="relative w-[150px] sm:w-[170px] flex-shrink-0 snap-start bg-white rounded-[16px] shadow-[0_4px_12px_rgba(139,28,16,0.08)] border border-[#FFD700]/40 p-1.5 pt-4 transition-transform hover:scale-105">
                 {/* Live Timer Badge */}
                 <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#8B1C10] text-white text-[12px] sm:text-[13px] font-bold px-2 py-1 rounded-full flex items-center justify-center gap-1 w-max border border-[#FFD700] shadow-sm z-20 whitespace-nowrap">
