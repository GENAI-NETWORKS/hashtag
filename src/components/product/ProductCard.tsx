  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden bg-[#f8f9fa] aspect-square">
        ...
        <div className="absolute top-2 left-2 flex flex-col gap-1">
          {product.isBestseller && (
            <span className="badge badge-magenta text-[10px] px-2 py-0.5">
              <Zap size={9} />Bestseller
            </span>
          )}
          {product.isFeatured && !product.isBestseller && (
            <span className="badge badge-cyan text-[10px] px-2 py-0.5">Featured</span>
          )}
        </div>
      </div>
      ...
      <div className="p-3 flex flex-col flex-1">
        <p className="text-[10px] text-[#888] font-medium uppercase tracking-wide mb-0.5 truncate">
        ...
        {product.reviewCount > 0 && (
          <div className="flex items-center gap-1 mt-1.5">
            ...
            <span className="text-[10px] text-[#888]">({product.reviewCount})</span>
          </div>
        )}
        ...
        <div className="flex items-center justify-between mt-2.5 gap-1 sm:gap-2">
          <div className="leading-none flex flex-col sm:flex-row sm:items-baseline">
            <span className="text-[13px] sm:text-base font-black text-[#111]">
          ...
          <button
            ...
            className="flex-shrink-0 flex items-center justify-center gap-1 px-2.5 sm:px-3 py-1.5 rounded-full text-[10px] sm:text-xs font-bold transition-all duration-200 min-h-[28px] sm:min-h-[32px]"
            style={{
              background: added
                ? '#16a34a'
                : adding
