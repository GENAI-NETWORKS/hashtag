  ...
  return (
    <div className="card p-4 flex gap-3 items-start animate-fadeInUp">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[12px] text-[#888] font-medium mb-0.5 truncate">
        ...
        {(item.variant?.size || item.variant?.color) && (
          <div className="flex gap-1.5 mt-1 flex-wrap">
            ...
            {item.variant.color && (
              <span className="text-[12px] px-2 py-0.5 rounded-full bg-[#f8f9fa] text-[#444] font-medium">
                {item.variant.color}
              </span>
            )}
          </div>
  ...
  if (items.length === 0) {
    return (
      <div className="container-app py-20 flex flex-col items-center text-center">
        ...
        <Link href="/products" className="btn btn-primary px-6 mx-auto w-fit font-bold">
